...
public class CreateFragment extends Fragment {
    ...
    private void updateUI() {
        ...
        data = fireBaseHandler.retrieveHostSiteData(FirebaseAuth.getInstance().getCurrentUser().getEmail());
        data.get(0).addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                createAdapter = new CreateAdapter(CreateFragment.this.getContext(), siteList);
                recyclerView.setLayoutManager(new GridLayoutManager(CreateFragment.this.getContext(), 1));
